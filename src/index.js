...
class ProblemService extends Service {
  ...
  registerServiceEndpoints() {
    ...
    this.app.delete(`${PROBLEMS_API}/playlist/assign/:playlistId`, verifyScope('PLAYLIST.D'), routes.playlist.unassignSheetToPlaylist);
    this.app.get(`${PROBLEMS_API}/playlist/assign/:playlistId`, verifyScope('PLAYLIST.V'), routes.playlist.getAssignedSheetsToPlaylist);
  }
}
